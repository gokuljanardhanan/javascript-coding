var closeStrings = function (word1, word2) {
  ...
  const uniqueChars1 = [...freqMap1.keys()].sort();
  const uniqueChars2 = [...freqMap2.keys()].sort();

  if (uniqueChars1.join("") !== uniqueChars2.join("")) return false;

  const freqValues1 = [...freqMap1.values()].sort((a, b) => a - b);
  const freqValues2 = [...freqMap2.values()].sort((a, b) => a - b);
